                ...
                @forelse ($employees as $employee)
                    <tr>
                        ...
                        <td>
                            ...
                            <!-- Edit Report Button -->
                            @if($employee->dailyReports->isNotEmpty()) <!-- Check if the employee has at least one report -->
                                <a href="{{ route('daily_reports.edit', ['daily_report' => $employee->dailyReports->first()->id]) }}" class="btn btn-warning btn-xs">Edit Report</a>
                            @endif
                        </td>
